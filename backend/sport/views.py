    ...
    def by_record(self, request):
        ...
        for user_record in user_records:
            ...
            if record.units == 'time':
                record_data['formatted_record'] = f"{str(user_record.time_value)} h:m:s" if user_record.time_value else '-'
            elif record.units == 'weight':
                record_data['formatted_record'] = f"{user_record.weight_value} kg" if user_record.weight_value else '-'
